    ...
    <div className="w-full h-screen">
      ...
      <div className="relative z-10 w-11/12 md:w-[600px] bg-black/60 rounded-md h-[50vh] left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 px-8 py-4">
        <div className="flex items-center flex-col justify-center h-full">
          ...
          <Button
            className="mt-4 flex items-center w-full h-10 sm:h-[56px] rounded !bg-red-600 !text-white hover:opacity-90 transition"
            onClick={() => signIn("google")}
          >
            <FaGoogle className="w-6 sm:w-7 h-6 sm:h-7 mr-2" />
            Sign in with Google
          </Button>
          <Button
            className="mt-4 flex items-center w-full h-10 sm:h-[56px] rounded !bg-gray-400 !text-white hover:opacity-90 transition"
